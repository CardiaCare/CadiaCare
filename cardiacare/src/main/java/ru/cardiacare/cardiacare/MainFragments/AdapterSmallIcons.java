...
// Адаптер для подстановки иконок меню на FragmentRegisteredScreenSmallIcons

public class AdapterSmallIcons extends BaseAdapter {
    public Context context;
    private final String[] textArrayValues;

    public AdapterSmallIcons(Context context, String[] textArrayValues) {
